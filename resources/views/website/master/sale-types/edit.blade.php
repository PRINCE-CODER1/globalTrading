...
<div class="container">
    <div class="row">
        <div class="col-12 d-flex justify-content-between mt-5">
            ...
            <a href="{{ route('sale-types.index') }}" class="btn btn-outline-secondary">
...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-12 mb-5 mt-3 bg-white p-5 shadow">
            <form action="{{ route('sale-types.update', $saleType->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter name" value="{{ old('name', $saleType->name) }}" required>
                        @error('name')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="Enter description">{{ old('description', $saleType->description) }}</textarea>
                </div>
