...
<div class="container">
    <div class="row">
        <div class="col-12 d-flex justify-content-between mt-5 mb-2">
            <h2 class="mb-0 d-flex justify-content-center text-center align-items-center">Create Leads Type</h2>
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style2 mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create Lead Type</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 mb-5 mt-3 bg-white p-5 shadow">
            ...
            <form action="{{ route('leads-types.store') }}" method="POST">
                ...
                <button type="submit" class="btn btn-secondary"><i class="ri-add-circle-line me-1"></i> Create Lead Type</button>
            </form>
        </div>
    </div>
</div>
