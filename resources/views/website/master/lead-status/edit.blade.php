                ...
                <div class="col-12 mb-5 mt-3 bg-white p-5 shadow">
                    <form action="{{ route('leads-status.update', $lead->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="status" name="status" value="{{ old('status', $lead->status) }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="details" class="form-label">Details</label>
                            <textarea class="form-control" id="details" name="details">{{ old('details', $lead->details) }}</textarea>
                        </div>
