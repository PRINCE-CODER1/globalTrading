        ...
        <div class="card-body">
            <form wire:submit.prevent="create">
                ...
                <div class="table-responsive">
                        ...
                        <tbody>
                            @foreach($products as $index => $product)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" wire:click.prevent="removeProduct({{ $index }})" class="btn btn-sm btn-danger">
                    ...
                    <button type="button" wire:click.prevent="addProduct" class="btn btn-info btn-sm mb-3 mt-1">
                        <i class="ri-add-circle-line"></i> Add Product
                    </button>
                </div>

                <button type="submit" class="btn btn-secondary">
                    <i class="ri-save-3-line"></i> Create External Chalaan
                </button>
            </form>
        </div>
    </div>
