        ...
        <div class="container">
            <div class="row mt-5 mb-3">
                <div class="col-12 d-flex align-items-center justify-content-between">
                    <h4>Lead Status</h4>
                    <a href="{{ route('leads-types.create') }}" class="btn btn-secondary"><i class="ri-add-circle-line"></i> Lead Type</a>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        @forelse($leads as $lead)
                                            <tr wire:key="{{ $lead->id }}">
                                                ...
                                                <td>{{ $lead->details }}</td>
                                                <td>
                                                    <a href="{{ route('leads-types.edit', $lead->id) }}" class="btn btn-link text-info"><i class="ri-edit-line"></i></a>
