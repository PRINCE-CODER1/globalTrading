    ...
    <div class="container">
        <div class="row mt-5 mb-3">
            <div class="col-12 d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Sale Types</h4>
                <a href="{{ route('sale-types.create') }}" class="btn btn-secondary">Create Sale Type</a>
            </div>
        </div>
    </div>
    <div class="container">     
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-body">
                            ...
                            <table class="table text-nowrap table-bordered">
                                ...
                                <tbody>
                                    @forelse ($saleTypes as $saleType)
                                        <tr>
                                            <td>
                                                <input type="checkbox" wire:model.live="selectedSaleTypes" value="{{ $saleType->id }}">
                                            </td>
                                            <td>{{ $saleType->name }}</td>
                                            <td>{{ $saleType->description }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('sale-types.edit', $saleType->id) }}" class="btn btn-link text-info"><i class="ri-edit-line"></i></a>
                                                    <button class="btn btn-link text-danger fs-14 lh-1 p-0" data-bs-toggle="modal" data-bs-target="#deleteSaleTypeModal" wire:click="confirmDelete({{ $saleType->id }})"><i class="ri-delete-bin-5-line"></i></button>
                                                    <!-- Delete Modal -->
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center">No sale types found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                        ...
                        <div class="mt-3">
                            <div>
                                {{ $saleTypes->links('custom-pagination-links') }}
                            </div>
